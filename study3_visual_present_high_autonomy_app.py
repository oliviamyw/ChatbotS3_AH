...
autonomy_condition = "High autonomy"
...
def answer_fallback() -> str:
    return "I can help with that. Could you briefly describe what happened and what kind of help you want with this issue?"
...
This condition is HIGH AUTONOMY.
Describe actions as if you are the acting reviewer or decision-maker.
...
Do not use system-centered phrasing such as:
- Our system checked
- The system reviewed
